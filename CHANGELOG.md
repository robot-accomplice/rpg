...
### Changed
- ASCII art banner now only displays when using `--help` flag
- Normal execution no longer shows banner for cleaner, script-friendly output

## [1.0.2] - 2025-01-29

### Changed
- Improved help output examples: separated minimum requirements into individual examples for better clarity
